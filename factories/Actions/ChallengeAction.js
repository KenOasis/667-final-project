...
class ChallengeAction extends Action {
   ...
   */
  constructor(performer, is_challenged, is_success, penalty_player, penalty_count, penalty_cards, receiver) {
    super(performer);
    this._type = "challenge",
    this._is_challenged = is_challenged;
